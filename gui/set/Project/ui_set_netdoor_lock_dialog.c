...
static void draw_bk(HDC hdc)
{
	...
	DrawTextFont(hdc, get_str(SID_Net_Door_LockTime), -1, &TextRc, DT_CALCRECT|DT_LEFT|DT_VCENTER|DT_SINGLELINE);
	DrawTextFont(hdc, get_str(SID_Net_Door_LockTime), -1, &TextRc, DT_LEFT|DT_VCENTER|DT_SINGLELINE);
}
