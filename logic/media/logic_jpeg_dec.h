...
#define MS_JPEG_DEC_PARAM		MS_MEDIA_METHOD(MS_JPEG_DEC_ID,0x00, const char)
#define MS_JPEG_DEC_OPEN		MS_MEDIA_METHOD(MS_JPEG_DEC_ID,0x02, JpegDecParam)
#define MS_JPEG_DEC_CLOSE		MS_MEDIA_METHOD_NO_ARG(MS_JPEG_DEC_ID,0x03)
#define MS_JPEG_DEC_SHOW		MS_MEDIA_METHOD_NO_ARG(MS_JPEG_DEC_ID,0x04)
#endif
