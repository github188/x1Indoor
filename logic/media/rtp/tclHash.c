 ...
 * the Columbia/Lucent RTP library.
 *
				 ...
				 * entry was created. */
{
    ...
    *newPtr = 1;
    hPtr = (Tcl_HashEntry *) ckalloc((unsigned)
	    (sizeof(Tcl_HashEntry) + strlen((char *)key) - (sizeof(hPtr->key) -1)));
 ...
 */
	...
	/* ARGSUSED */
static Tcl_HashEntry *
BogusFind(ARG_UNUSED(Tcl_HashTable*, tablePtr),
	  ARG_UNUSED(CONST char*, key))
     /* Tcl_HashTable *tablePtr; */	/* Table in which to lookup entry. */
     /* CONST char *key; */	/* Key to use to find matching entry. */
{
 ...
 */
	...
	/* ARGSUSED */
static Tcl_HashEntry *
BogusCreate(ARG_UNUSED(Tcl_HashTable *, tablePtr),
	    ARG_UNUSED(CONST char *, key),
	    ARG_UNUSED(int*, newPtr))
     /* Tcl_HashTable *tablePtr; */	/* Table in which to lookup entry. */
     /* CONST char *key; */		/* Key to use to find or create matching
				 * entry. */
     /* int *newPtr; */		/* Store info here telling whether a new
