/*************************************************
  ...
  File name: 	audio_endec.h
  Author:		chenbh
  Version:  	1.0
  Date: 		2015-04-27
  Description:  音频模块公用函数
...
#ifndef _AUDIO_ENDEC_H_
#define _AUDIO_ENDEC_H_
...
/*************************************************
  ...
  Description: 		G711解码数据转换
  Input: 		
  	1、pcm			PCM 数据
  	2、size			PCM 数据长度
  	3、lawflag		0: alaw 其他表示ulaw
  Output:	
  	1、code			编码后数据
  Return:		 
  Others:  
